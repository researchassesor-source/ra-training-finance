...
export default function ConfirmDialog({ open, onClose, onConfirm, title, message, loading, confirmLabel }) {
  return (
    <Modal open={open} onClose={onClose} title={title || 'Confirmar acción'} size="sm">
      <div className="flex flex-col items-center gap-4 py-2">
        ...
        <p className="text-center text-gray-600 text-sm whitespace-pre-line">{message || '¿Estás seguro de que deseas continuar?'}</p>
