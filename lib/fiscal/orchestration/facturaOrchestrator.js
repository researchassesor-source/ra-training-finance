...
export async function enviarFacturaARecepcion(facturaId, signedXml, options) {
  ...
  // recibió el comprobante antes de que fallara la conexión. Se libera el claim
  // (vuelve a SIGNED) para que continuarFlujoFactura, en un reintento posterior,
  // reconcilie primero contra Autorización antes de reenviar — ver
  // reconciliarSubmittingEnvejecido. Aquí NO se reenvía ciegamente.
