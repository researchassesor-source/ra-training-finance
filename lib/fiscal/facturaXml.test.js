...
describe('buildFacturaXml — estructura', () => {
  ...
  it('usa fecha de emisión fiscal Ecuador aunque el servidor esté en UTC al día siguiente', () => {
    const xml = buildFacturaXml(facturaPruebaSri({
      fechaEmision: new Date('2026-08-27T02:30:00.000Z'), // 26/08/2026 21:30 en Ecuador
    }))
    expect(xml).toContain('<fechaEmision>26/08/2026</fechaEmision>')
  })
