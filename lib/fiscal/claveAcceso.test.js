...
describe('generateClaveAcceso', () => {
  ...
  it('usa fecha fiscal de Ecuador aunque el runtime esté en UTC al día siguiente', () => {
    const { claveAcceso } = generateClaveAcceso({
      ...baseInput,
      issueDate: new Date('2026-08-27T02:30:00.000Z'), // 26/08/2026 21:30 en Ecuador
    })
    expect(claveAcceso.slice(0, 8)).toBe('26082026')
  })
